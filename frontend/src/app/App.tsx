...
import { ExamAiPanel, TodayAiPanel } from "./P3Pages";
...
function TodayPage({ provider }: { provider: AppSnapshot["provider"] | undefined }) {
  const { language, t } = useI18n();
...
function SubjectsPage() {
  ...
  if (subjectsQuery.isLoading || gradesQuery.isLoading || gradeExamsQuery.isLoading) return <PageLoading />;
