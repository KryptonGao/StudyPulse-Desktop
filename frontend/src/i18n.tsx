...
const workbenchAppearanceTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.presetOpenai": "OpenAI Neutral",
    ...
    "settings.presetOpenaiHint": "Slate & Emerald",
  ...
  "zh-CN": {
    ...
    "settings.presetOpenai": "OpenAI 中性灰",
    ...
    "settings.presetOpenaiHint": "石板灰与翠绿",
  ...
  "zh-TW": {
    ...
    "settings.presetOpenaiHint": "石板灰與翠綠",
  ...
  ja: {
    ...
    "settings.presetOpenai": "OpenAI ニュートラル",
    ...
    "settings.presetOpenaiHint": "スレートとエメラルド",
  ...
  ko: {
    ...
    "settings.presetOpenai": "OpenAI 뉴트럴",
    ...
    "settings.presetOpenaiHint": "슬레이트와 에메랄드",
