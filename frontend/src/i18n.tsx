...
const p2En: Record<string, string> = {
  ...
  "reports.title": "Learning Reports", "reports.studyTime": "Study time", "reports.sessions": "Sessions", "reports.score": "Score rate", "reports.mood": "Mood", "reports.share": "Share / open file",
...
const p2ZhCN: Record<string, string> = {
  ...
  "reports.title": "学习报告", "reports.studyTime": "学习时长", "reports.sessions": "学习 session", "reports.score": "成绩率", "reports.mood": "心情", "reports.share": "分享 / 打开文件",
