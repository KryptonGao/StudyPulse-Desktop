<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="StudyPulse：本地优先的学习工作区，把任务、复习、趋势和 Agent 工作放在一个可以回来的地方">
</p>
...
<p align="center">
  <img src="./assets/readme/workflow.svg" width="100%" alt="StudyPulse 数据边界：React 通过 Tauri 进入 Rust Core，默认写入本地 Workspace，AI 作为可选连接">
</p>
